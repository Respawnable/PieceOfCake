...
task main ()
{
	...
	//	if (_dirDC < 0)
		...
		if (!HTIRS2readAllACStrength(HTIRS2, acS1, acS2, acS3, acS4, acS5 ))
			break; // I2C read error occurred
		nxtDisplayTextLine(2, "D %d", _dirAC);
		nxtDisplayTextLine(3, "0 %d", acS1);
		nxtDisplayTextLine(4, "1 %d", acS2);
		nxtDisplayTextLine(5, "2 %d", acS3);
		nxtDisplayTextLine(6, "3 %d", acS4);
		nxtDisplayTextLine(7, "4 %d", acS5);
